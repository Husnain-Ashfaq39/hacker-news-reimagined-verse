	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'saveButtonPulse': 'save-button-pulse 0.8s cubic-bezier(0.4, 0, 0.6, 1)',
				'particle-1': 'particle-move-1 0.8s cubic-bezier(0.4, 0, 0.6, 1) forwards',
				'particle-2': 'particle-move-2 0.8s cubic-bezier(0.4, 0, 0.6, 1) forwards',
